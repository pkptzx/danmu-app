                        ...
                        <div class="q-pa-md row justify-center">
                            <div style="width: 100%;">
                                <template v-for="item in items" :key="item.id">
                                    ...
                                    :class="{'bg-liuguang':item.body.user.identity.guard_level>0}"
                                        ...
                                        :bg-color="item.body.user.identity.guard_level>0 ? 'transparent': item.body.user.uid == my_uid ? 'primary' : 'amber-7'"
...
@keyframes liuguang{
  0% {
    background: linear-gradient(to left, #A0F1EA 0%, #e3a5f0 100%, #A0F1EA 200%, #e3a5f0 300%);
  }

  5% {
    background: linear-gradient(to left, #A0F1EA -10%, #e3a5f0 90%, #A0F1EA 190%, #e3a5f0 290%);
  }

  10% {
    background: linear-gradient(to left, #A0F1EA -20%, #e3a5f0 80%, #A0F1EA 180%, #e3a5f0 280%);
  }

  15% {
    background: linear-gradient(to left, #A0F1EA -30%, #e3a5f0 70%, #A0F1EA 170%, #e3a5f0 270%);
  }

  20% {
    background: linear-gradient(to left, #A0F1EA -40%, #e3a5f0 60%, #A0F1EA 160%, #e3a5f0 260%);
  }

  25% {
    background: linear-gradient(to left, #A0F1EA -50%, #e3a5f0 50%, #A0F1EA 150%, #e3a5f0 250%);
  }

  30% {
    background: linear-gradient(to left, #A0F1EA -60%, #e3a5f0 40%, #A0F1EA 140%, #e3a5f0 240%);
  }

  35% {
    background: linear-gradient(to left, #A0F1EA -70%, #e3a5f0 30%, #A0F1EA 130%, #e3a5f0 230%);
  }

  40% {
    background: linear-gradient(to left, #A0F1EA -80%, #e3a5f0 20%, #A0F1EA 120%, #e3a5f0 220%);
  }

  45% {
    background: linear-gradient(to left, #A0F1EA -90%, #e3a5f0 10%, #A0F1EA 110%, #e3a5f0 210%);
  }

  50% {
    background: linear-gradient(to left, #A0F1EA -100%, #e3a5f0 0%, #A0F1EA 100%, #e3a5f0 200%);
  }

  55% {
    background: linear-gradient(to left, #A0F1EA -110%, #e3a5f0 -10%, #A0F1EA 90%, #e3a5f0 190%);
  }

  60% {
    background: linear-gradient(to left, #A0F1EA -120%, #e3a5f0 -20%, #A0F1EA 80%, #e3a5f0 180%);
  }

  65% {
    background: linear-gradient(to left, #A0F1EA -130%, #e3a5f0 -30%, #A0F1EA 70%, #e3a5f0 170%);
  }

  70% {
    background: linear-gradient(to left, #A0F1EA -140%, #e3a5f0 -40%, #A0F1EA 60%, #e3a5f0 160%);
  }

  75% {
    background: linear-gradient(to left, #A0F1EA -150%, #e3a5f0 -50%, #A0F1EA 50%, #e3a5f0 150%);
  }

  80% {
    background: linear-gradient(to left, #A0F1EA -160%, #e3a5f0 -60%, #A0F1EA 40%, #e3a5f0 140%);
  }

  85% {
    background: linear-gradient(to left, #A0F1EA -170%, #e3a5f0 -70%, #A0F1EA 30%, #e3a5f0 130%);
  }

  90% {
    background: linear-gradient(to left, #A0F1EA -180%, #e3a5f0 -80%, #A0F1EA 20%, #e3a5f0 120%);
  }

  95% {
    background: linear-gradient(to left, #A0F1EA -190%, #e3a5f0 -90%, #A0F1EA 10%, #e3a5f0 110%);
  }
